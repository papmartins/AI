<template>
  <Head :title="trans('Movies')" />
  <AuthenticatedLayout :title="trans('Movies')">
    <div class="max-w-7xl mx-auto p-6">
      <!-- Suggestions Section -->
      <div v-if="suggestions.length > 0" class="mb-12">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">🎬 {{ trans('Recommended for You') }}</h2>
      ...
      <div class="mb-8 flex flex-wrap gap-4">
        <input 
          v-model="search"
          @input="fetchMovies"
          :placeholder="trans('Search movies...')"
        >
